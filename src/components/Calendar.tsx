  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="w-full text-center flex flex-col py-2 gap-y-3">
        <p className="border-b w-fit mt-2 border-gray-500 text-black text-left">
          {date}
        </p>
        {dateQuery && (
          <Link
            href={`/expense/${dateQuery}`}
            className="bg-black uppercase tracking-wider w-full px-4 py-2 text-white rounded-3xl"
          >
